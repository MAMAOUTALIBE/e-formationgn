...
const fr: Dictionary = {
  ...
  hero: {
    ...
    description:
      "Accédez à des centaines de cours dispensés par des formateurs francophones confirmés. Apprenez à votre rythme et obtenez votre certification.",
...
const en: Dictionary = {
  ...
  hero: {
    ...
    description:
      "Access hundreds of courses taught by experienced French-speaking instructors. Learn at your own pace and earn your certification.",
