...
export async function SiteHeader() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 w-full border-b border-slate-200/80 bg-white/95 shadow-[0_8px_24px_rgba(15,23,42,0.06)] backdrop-blur supports-[backdrop-filter]:bg-white/85">
      ...
      <div aria-hidden="true" className="h-[69px] w-full" />
    </>
  );
}
