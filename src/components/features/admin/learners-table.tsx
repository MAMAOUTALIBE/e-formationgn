...
// `focus:` autant que `focus-visible:` — à l'ouverture, le premier élément
// reçoit le focus par programme après un clic souris : `:focus-visible` ne
// s'applique alors pas et l'élément actif ne se voyait pas.
const MENU_ITEM_CLASS = "flex w-full items-center gap-2 rounded-lg px-2.5 py-2 font-medium hover:bg-muted focus:bg-muted focus-visible:bg-muted focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-40";
