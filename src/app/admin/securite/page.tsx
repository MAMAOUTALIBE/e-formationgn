  ...
  return (
    <div className="space-y-5">
      ...
      <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <KpiCard label="Sessions actives" value={activeSessions} href="/admin/securite/sessions" />
      ...
      <Card>
        ...
        <CardContent>
          <ul className="grid gap-2 text-sm sm:grid-cols-2">
            ...
            <SecurityTile href="/admin/securite/sessions" label="Sessions" description="Sessions actives, déconnexion forcée." />
